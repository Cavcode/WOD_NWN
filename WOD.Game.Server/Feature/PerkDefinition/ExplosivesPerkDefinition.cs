    ...
    public class ExplosivesPerkDefinition: IPerkListDefinition
    {
        ...
        private void IonGrenade()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.IonGrenade)
                ...
                .AddPerkLevel()
                .Description("Deals 8 electrical DMG to all enemies within range of explosion. Also has a 50% chance to inflict stun to droids. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Deals 14 electrical DMG to all enemies within range of explosion. Also has a 70% chance to inflict stun to droids. Consumes explosives on use.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 35)
                .RequirementCharacterType(CharacterType.Standard)
        ...
        private void Flamethrower()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.Flamethrower)
                ...
                .AddPerkLevel()
                .Description("Deals 10 fire DMG to all targets within a cone in front of the user. Also has a 30% chance to inflict Burning.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 20)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Deals 16 fire DMG to all targets within a cone in front of the user. Also has a 50% chance to inflict Burning.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 40)
                .RequirementCharacterType(CharacterType.Standard)
        ...
        private void WristRocket()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.WristRocket)
                ...
                .AddPerkLevel()
                .Description("Inflicts 12 fire DMG to a single target. Also has a 30% chance to inflict Knockdown.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 25)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Inflicts 20 fire DMG to a single target. Also has a 50% chance to inflict Knockdown.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 40)
                .RequirementCharacterType(CharacterType.Standard)
