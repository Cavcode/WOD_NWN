namespace WOD.Game.Server.Feature.AppearanceDefinition.ItemAppearance
{
    public class DroidArmorAppearanceDefinition: IArmorAppearanceDefinition
    {
        ...
        public int[] Torso { get; } = {1, 2, 200, 201, 202, 203, 204, 205, 206, 207 };
        public int[] Belt { get; } = { 0 };
        public int[] Pelvis { get; } = {1,};

        public int[] Shoulder { get; } = {0, };
        public int[] Bicep { get; } = {1, 2, 200, 201, 202, 203, 204, 205 };
        public int[] Forearm { get; } = {1, 2, 200, 201, 202, 203, 204, 205 };
