...
using Ability = WOD.Game.Server.Service.Ability;
using AttackType = WOD.Game.Server.Enumeration.AttackType;
using BaseItem = WOD.Game.Server.Core.NWScript.Enum.Item.BaseItem;
using FeatType = WOD.Game.Server.Core.NWScript.Enum.FeatType;
...
namespace WOD.Game.Server.Native
{
    public static unsafe class ResolveAttackRoll
    {
        ...
        private static void OnResolveAttackRoll(void* thisPtr, void* pTarget)
        {
            ...
            /*
             * Custom attack logic for WOD. Most default NWN logic does not apply.
             * 
