namespace WOD.Game.Server.Service.PerkService
{
    ...
    public enum PerkType
    {
        ...
        RapidSynthesisConstruction = 146,
        CarefulSynthesisConstruction = 147,
        BasicTouchConstruction = 148,
        FurnitureBlueprints = 149,
        StructureBlueprints = 150,
        Chi = 151,
        StarshipBlueprints = 152,
        StandardTouchConstruction = 153,
        PreciseTouchConstruction = 154,
        MastersMendConstruction= 155,
        SteadyHandConstruction = 156,
        Harvesting = 157,
        Refining = 158,
        ...
        Ironclad = 175,
        Mobility = 176,
        MuscleMemoryConstruction = 177,
        VenerationConstruction = 178,
        WasteNotConstruction = 179,
        Dash = 180,
        TreasureHunter = 181,
        CreditFinder = 182,
        ...
        WasteNotCooking = 192,
        CookingRecipes = 193,
        RapidSynthesisGunsmithing = 194,
        CarefulSynthesisGunsmithing = 195,
        BasicTouchGunsmithing = 196,
        StandardTouchGunsmithing = 197,
        PreciseTouchGunsmithing = 198,
        MastersMendGunsmithing = 199,
        SteadyHandGunsmithing = 200,
        MuscleMemoryGunsmithing = 201,
        VenerationGunsmithing = 202,
        WasteNotGunsmithing = 203,
        FragGrenade = 204,
        ...
        GunsmithingEquipment = 221,
        ConstructionEquipment = 222,
