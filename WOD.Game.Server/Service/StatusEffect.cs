...
namespace WOD.Game.Server.Service
{
    public static class StatusEffect
    {
        ...
        private static readonly Dictionary<EffectIconType, AbilityType> _abilityIncreaseIconType = new()
        {
            ...
            { EffectIconType.AbilityIncreaseDEX, AbilityType.Dexterity },
            { EffectIconType.AbilityDecreaseDEX, AbilityType.Dexterity },
            { EffectIconType.AbilityIncreaseCON, AbilityType.Vitality },
            { EffectIconType.AbilityDecreaseCON, AbilityType.Vitality },
            { EffectIconType.AbilityIncreaseINT, AbilityType.Power },
            { EffectIconType.AbilityDecreaseINT, AbilityType.Power },
