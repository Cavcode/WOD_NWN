...
namespace WOD.Game.Server.Service
{
    public static class Migration
    {
        ...
        private static void RunServerMigrations()
        {
            ...
            var serverConfig = DB.Get<ServerConfiguration>("WOD_CONFIG") ?? new ServerConfiguration();
            ...
            serverConfig = DB.Get<ServerConfiguration>("WOD_CONFIG") ?? new ServerConfiguration();
