...
using Alignment = WOD.Game.Server.Core.NWScript.Enum.Item.Property.Alignment;
using AlignmentGroup = WOD.Game.Server.Core.NWScript.Enum.Item.Property.AlignmentGroup;
