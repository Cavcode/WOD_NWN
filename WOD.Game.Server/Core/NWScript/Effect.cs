...
using Alignment = WOD.Game.Server.Core.NWScript.Enum.Alignment;
using DamageType = WOD.Game.Server.Core.NWScript.Enum.DamageType;
using RacialType = WOD.Game.Server.Core.NWScript.Enum.RacialType;
using SpellSchool = WOD.Game.Server.Core.NWScript.Enum.SpellSchool;
...
namespace WOD.Game.Server.Core.NWScript
{
    public partial class NWScript
    {
        ...
        /// NOTE: On WOD, this is used for Accuracy.
