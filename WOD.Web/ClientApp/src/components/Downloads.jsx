                    ...
                    <table className="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Extract all .hak files to your My Documents/Neverwinter Nights/hak directory. Extract the WOD_tlk.tlk file to your tlk directory. Make the tlk directory if it doesn't already exist</td>
                                <td>
