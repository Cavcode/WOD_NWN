                        ...
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <div className="dropdown-menu">
                                    <a className="dropdown-item" href="https://github.com/zunath/WOD_NWN" target="_blank" rel="noopener noreferrer">
                                        <i className="fa fa-code" /> &nbsp;Server Source Code
                                    </a>
                                    <a className="dropdown-item" href="https://github.com/zunath/WOD_Website" target="_blank" rel="noopener noreferrer">
