...
using LegacyPlayer = WOD.CLI.LegacyMigration.Player;
using RevampPlayer = WOD.Game.Server.Entity.Player;
...
namespace WOD.CLI
{
    internal class LegacyMigrator
    {
         ...
         * mysqldump -u <userName> -p WOD ApartmentBuilding Area Association Attribute AuthorizedDM Backgrounds Bank BankItem BaseItemType PCGuildPoint PCKeyItem PCMapPin PCMapProgression PCObjectVisibility PCQuestItemProgress PCQuestKillTargetProgress PCQuestStatus PCSkill Player ServerConfiguration  > WOD_dump.sql
         */
        ...
        {
            using (var context = new WODContext())
            {
        ...
        private void MigratePlayers()
        {
            ...
            foreach (var oldPlayer in oldPlayers)
            {
                ...
                var newPlayer = new RevampPlayer(oldPlayer.Id)
                {
                    ...
                    TemporaryFoodHP = 0,
                    BAB = 1,
                    LocationAreaResref = "czs220_hangar",
                    LocationX = 24.142864f,
                    LocationY = 37.1822f,
                    LocationZ = 0.0f,
                    LocationOrientation = 90f,
                    RespawnAreaResref = "czs220_hangar",
                    RespawnLocationX = 24.142864f,
                    RespawnLocationY = 37.1822f,
                    RespawnLocationZ = 0.0f,
                    RespawnLocationOrientation = 90f,
                    UnallocatedXP = 0,
                    UnallocatedSP = sp + 10,
                    UnallocatedAP = ap,
                    TotalSPAcquired = sp,
