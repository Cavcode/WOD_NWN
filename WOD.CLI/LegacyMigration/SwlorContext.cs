...
namespace WOD.CLI.LegacyMigration
{
    public partial class WODContext : DbContext
    {
        public WODContext()
        {
        }

        public WODContext(DbContextOptions<WODContext> options)
            : base(options)
        {
        }
        ...
        {
            var connectionString = ConfigurationManager.ConnectionStrings["WODContext"].ConnectionString;
